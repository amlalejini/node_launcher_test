...
class Dummy_Node_C(object):
	...
	def __init__(self):
		...
		rospy.init_node("anon_node_C", anonymous = True)
		...
		pub = rospy.Publisher(rospy.get_name() + "/type_C_chatter", String)
		# initialize anonymous name publisher
		name_pub = rospy.Publisher("anon_name_report", String)
		time.sleep(0.25)
